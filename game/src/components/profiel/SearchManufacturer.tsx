...
import { SearchManufacturerprops } from "../../type/index";
                ...
                <div className="relative mt-10">
                    <div className="relative w-full cursor-default overflow-hidden rounded-lg bg-white text-left shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-teal-300 sm:text-sm">
                        <Combobox.Input
                            ...
                            placeholder='search...'
                            autoComplete='off' // hidden the old value
                    ...
                    <Transition
                        ...
                        afterLeave={() => setQuery('')}
                    >
                        <Combobox.Options className=" mt-1 max-h-60 w-full overflow-hidden rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
